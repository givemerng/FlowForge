...
export const TaskCard: React.FC<TaskCardProps> = ({ task }) => {
  return (
    <div className="bg-surface-container-lowest border border-outline-variant rounded-lg p-md hover:border-primary/50 hover:shadow-[0_4px_12px_rgba(0,0,0,0.08)] transition-all cursor-grab group mb-sm">
